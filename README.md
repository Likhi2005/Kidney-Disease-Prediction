...
```bash
https://github.com/Likhi2005/Kidney-Disease-Prediction
```
...
```bash
conda create -n kidneyCnn python=3.10.19 -y
```
...
## 3. Create ECR repo to store/save docker image
    - Save the URI: <1239129389>.dkr.ecr.us-east-1.amazonaws.com/name
